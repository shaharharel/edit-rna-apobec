...
Usage:
    ...
    python scripts/apobec3a/extract_sequences_and_structures.py --genome data/raw/genomes/hg38.fa
    python scripts/apobec3a/extract_sequences_and_structures.py --negatives  # also process negatives
"""
