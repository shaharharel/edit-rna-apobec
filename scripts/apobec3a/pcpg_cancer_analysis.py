...
OUT = os.path.join(BASE, "experiments/apobec3a/outputs/pcpg_analysis")
...
PRED_PATH = os.path.join(BASE, "experiments/apobec3a/outputs/iteration3/test_predictions.csv")
RATE_PATH = os.path.join(BASE, "experiments/apobec3a/outputs/rate_prediction/rate_predictions.csv")
