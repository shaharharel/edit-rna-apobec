...
Usage:
    conda run -n quris python scripts/apobec/generate_rnasee_embeddings.py
    conda run -n quris python scripts/apobec/generate_rnasee_embeddings.py --batch-size 32
"""
