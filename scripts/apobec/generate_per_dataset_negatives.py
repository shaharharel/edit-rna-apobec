...
Usage:
    python scripts/apobec/generate_per_dataset_negatives.py
    python scripts/apobec/generate_per_dataset_negatives.py --neg-ratio 10
    python scripts/apobec/generate_per_dataset_negatives.py --genome /path/to/hg19.fa
"""
