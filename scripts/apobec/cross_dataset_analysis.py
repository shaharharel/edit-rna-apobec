...
Usage:
    # Full analysis
    python scripts/apobec/cross_dataset_analysis.py

    # Only dataset characterization (no model training)
    python scripts/apobec/cross_dataset_analysis.py --characterize-only

    # Only cross-dataset generalization matrix
    python scripts/apobec/cross_dataset_analysis.py --generalization-only
"""
