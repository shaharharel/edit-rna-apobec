...
Usage:
    python experiments/apobec3a/evaluate_editrna.py \\
        --checkpoint experiments/apobec3a/outputs/exp1_rnafm_v1/best_model.pt \\
        --output_dir experiments/apobec3a/outputs/exp1_rnafm_v1/eval
"""
