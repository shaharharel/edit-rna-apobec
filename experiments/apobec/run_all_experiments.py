...
Usage:
    ...
    python experiments/apobec/run_all_experiments.py

    # Run a subset
    python experiments/apobec/run_all_experiments.py --models concat_mlp subtraction_mlp
    python experiments/apobec/run_all_experiments.py --neg-ratios 5 10
    python experiments/apobec/run_all_experiments.py --seeds 42

    # Just re-aggregate existing results (no training)
    python experiments/apobec/run_all_experiments.py --aggregate-only
"""
