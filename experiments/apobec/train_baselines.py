...
Usage:
    ...
    python experiments/apobec/train_baselines.py --model concat_mlp --epochs 50

    # Train all baselines
    python experiments/apobec/train_baselines.py --model all --epochs 50

    # Different negative ratio
    python experiments/apobec/train_baselines.py --model all --neg-ratio 5

    # Evaluate existing checkpoint
    python experiments/apobec/train_baselines.py --model concat_mlp --evaluate-only
"""
