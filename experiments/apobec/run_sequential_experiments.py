...
Usage:
    ...
    KMP_DUPLICATE_LIB_OK=TRUE python experiments/apobec/run_sequential_experiments.py

    # Resume from a specific step (e.g., after a crash):
    KMP_DUPLICATE_LIB_OK=TRUE python experiments/apobec/run_sequential_experiments.py --start-from 5

    # Run only specific experiments:
    KMP_DUPLICATE_LIB_OK=TRUE python experiments/apobec/run_sequential_experiments.py --only dataset_deep_analysis multitask

    # Dry-run (show what would run):
    KMP_DUPLICATE_LIB_OK=TRUE python experiments/apobec/run_sequential_experiments.py --dry-run
"""
...
EXPERIMENTS = [
    # --- Phase 1: Analysis-only (CSV data, no embeddings) ~50MB each ---
    {
        ...
        "script": "experiments/apobec/exp_dataset_deep_analysis.py",
    ...
    {
        "name": "gate_ablation",
        "script": "experiments/apobec/exp_gate_ablation.py",
    ...
    {
        "name": "motif_analysis",
        "script": "experiments/apobec/exp_motif_analysis.py",
    ...
    },
    {
        ...
        "script": "experiments/apobec/exp_structure_analysis.py",
    ...
    # --- Phase 2: Pooled embeddings only (~200MB each) ---
    {
        ...
        "script": "experiments/apobec/exp_embedding_visualizations.py",
    ...
    {
        "name": "multitask",
        "script": "experiments/apobec/exp_multitask_comparison.py",
    ...
    },
    {
        ...
        "script": "experiments/apobec/exp_incremental_spearman.py",
    ...
    },
    {
        ...
        "script": "experiments/apobec/exp_incremental_datasets.py",
    ...
    {
        "name": "dataset_matrix",
        "script": "experiments/apobec/exp_dataset_matrix.py",
    ...
    },
    {
        ...
        "script": "experiments/apobec/exp_rate_prediction.py",
    ...
    # --- Phase 3: Tissue/biology analyses (pooled embeddings + CSVs) ---
    {
        ...
        "script": "experiments/apobec/exp_cross_tissue_disease.py",
    ...
    },
    {
        ...
        "script": "scripts/apobec/constitutive_facultative_analysis.py",
    ...
    },
    {
        ...
        "script": "experiments/apobec/exp_tissue_conditioned_rate.py",
    ...
    {
        "name": "tissue_motifs",
        "script": "scripts/apobec/tissue_motif_analysis.py",
    ...
    {
        "name": "pcpg_analysis",
        "script": "scripts/apobec/pcpg_cancer_analysis.py",
    ...
    },
    {
        ...
        "script": "experiments/apobec/exp_binary_rate_correlation.py",
    ...
    },
    {
        ...
        "script": "experiments/apobec/exp_levanon_tissue_viz.py",
    ...
    # --- Phase 4: Heavy experiments (token-level embeddings ~13GB) ---
    {
        ...
        "script": "experiments/apobec/exp_dataset_matrix_editrna.py",
    ...
    },
    {
        ...
        "script": "experiments/apobec/exp_incremental_editrna.py",
